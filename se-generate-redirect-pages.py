            ...
            if (seCode) {
                if (redirectMap[seCode]) {
                    ...
                    document.getElementById("error_message").innerHTML = "<p>Invalid or missing Swift Evolution proposal code: &quot;" + seCode + "&quot;</p>"
                        + "<p>If that proposal code exists, ask <a href=\\\"https://www.linkedin.com/in/alex-hunsley-385937\\\">alex hunsley</a> to run <code>se-generate-redirect-pages.py</code> again.</p>";
                } 
            }
            else {
